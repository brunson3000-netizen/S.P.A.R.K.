...
fn r2prime_frozen_q7_full_cadence_after_fresh_assignment() {
    ...
    let mut e = make(100,10,10,9,&[10],false,None);
    run(&mut e,10);
    assert_eq!(state(&e),(100,LogicalTime(10)),"v1 Q7: no whole cadence has elapsed since updated_at=9");
}
...
fn r2prime_frozen_q7_full_cadence_after_separate_shock() {
    ...
    run(&mut e,40);
    assert_eq!(state(&e),(75,LogicalTime(40)),"v2 4.3 retains Q7: nine units after the shock is not a whole cadence");
}
